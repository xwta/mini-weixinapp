  ...
  <view class="suggestion-card">
    ...
    <view v-if="displayReferences.length" class="refs">
      <view class="refs-head">
        <text class="refs-title">曲谱资源</text>
      ...
      >
        ...
        <view class="ref-main">
          ...
          <text class="ref-snippet">{{ item.snippet || item.source_site || item.provider || '曲谱资源' }}</text>
    ...
    <view class="notice">系统会同时生成 TXT 弹唱谱和图片六线谱，详情页可自由切换查看。</view>

    <view class="actions">
      <view class="ghost-btn" @tap="emit('back')">返回结果</view>
      <view class="generate-btn" :class="{ loading }" @tap="generateFullTab">
        {{ loading ? '生成中' : '生成完整曲谱' }}
      </view>
    </view>
  </view>
...
function generateFullTab() {
  ;(props.candidate as any).preferred_output_type = 'both'
  emit('generate')
}
...
.title { margin-top: 6rpx; color: #17231E; font-size: 31rpx; line-height: 40rpx; font-weight: 900; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.score { min-width: 72rpx; height: 48rpx; padding: 0 14rpx; border-radius: 999rpx; background: #F0FBF5; color: #0BA45A; font-size: 22rpx; font-weight: 800; display: flex; align-items: center; justify-content: center; box-sizing: border-box; }
.artist, .summary { display: block; margin-top: 18rpx; color: #5F6B65; font-size: 25rpx; line-height: 38rpx; }
.summary { margin-top: 12rpx; }
.refs { margin-top: 20rpx; padding: 18rpx; border-radius: 20rpx; background: #F6FBF8; }
.refs-head { display: flex; align-items: center; justify-content: space-between; }
.refs-title { display: block; color: #17231E; font-size: 24rpx; line-height: 30rpx; font-weight: 800; }
.refs-count { color: #0BA45A; font-size: 21rpx; font-weight: 800; }
.ref-item { margin-top: 14rpx; padding: 14rpx; border-radius: 18rpx; background: #FFFFFF; border: 1rpx solid #E8EFEA; display: flex; align-items: center; }
.ref-thumb { width: 82rpx; height: 82rpx; margin-right: 14rpx; border-radius: 14rpx; background: #EAF8F0; flex-shrink: 0; }
.ref-thumb--empty { color: #0BA45A; font-size: 26rpx; font-weight: 900; display: flex; align-items: center; justify-content: center; }
.ref-main { flex: 1; min-width: 0; }
.ref-title-row { display: flex; align-items: center; min-width: 0; }
.ref-text { flex: 1; min-width: 0; color: #17231E; font-size: 24rpx; line-height: 32rpx; font-weight: 800; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.type-pill { height: 30rpx; margin-left: 8rpx; padding: 0 10rpx; border-radius: 999rpx; font-size: 18rpx; line-height: 30rpx; font-weight: 800; flex-shrink: 0; }
...
.ref-snippet, .ref-url { display: block; margin-top: 5rpx; color: #7B8580; font-size: 21rpx; line-height: 28rpx; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.ref-url { color: #A0AAA5; }
...
.ghost-btn, .generate-btn { flex: 1; height: 68rpx; border-radius: 999rpx; display: flex; align-items: center; justify-content: center; font-size: 25rpx; font-weight: 800; }
.ghost-btn { background: #F6FAF8; color: #5F6B65; border: 1rpx solid #E8EFEA; }
.generate-btn { background: #17231E; color: #FFFFFF; border: 1rpx solid #17231E; }
.generate-btn.loading { opacity: .68; }
